...
<div class="featured-wrap clearfix">
	<a href="<?php the_permalink() ?>" title="<?php the_title(); ?>" rel="nofollow" class="post-image post-image-fullwidth" <?php if (mts_get_category_color()) { echo ' style="border-color: '.mts_get_category_color().';"'; } ?>>
		<?php echo '<div class="featured-thumbnail">'; the_post_thumbnail('featured-blog',array('title' => '')); echo '</div>'; ?>
