					...
					<div class="post-data-container">
						...
						<div class="post-info">
							...
							<?php if ( $comment_num == 1 ) : ?>
								<span class="thecomment"><?php echo comments_number(__('No Comment','mythemeshop'), __('One Comment','mythemeshop'), '<span class="comm">%</span> '.__('Comments','mythemeshop'));?></span>
							<?php endif; ?>
						</div><!--.post-info-->
						<?php endif; ?>
