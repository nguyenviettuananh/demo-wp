...
function mts_inner_posttemplate_metabox($post) {
    ...
    */
    ...
    echo '<option value="" '.selected('', $posttemplate).'>'.__('Post Template 1', 'mythemeshop').'</option>';
    echo '<option value="template2" '.selected('template2', $posttemplate).'>'.__('Post Template 2', 'mythemeshop').'</option>';
    echo '</select><br />';
}
