...
class Facebook_Like_Widget extends WP_Widget {
	...
	function widget($args, $instance)
	{
		...
		if($page_url): ?>
			<div class="fb-like-box" data-href="<?php echo $page_url; ?>" data-height="<?php echo $height; ?>" data-width="<?php echo $width; ?>" data-colorscheme="<?php echo $color_scheme; ?>" data-show-faces="<?php echo $show_faces; ?>" data-header="<?php echo $show_header; ?>" data-stream="<?php echo $show_stream; ?>" data-show-border="false" ></div>
		<?php endif;
	...
	{
		$defaults = array('title' => __('Find us on Facebook','mythemeshop'), 'page_url' => '', 'width' => '300', 'color_scheme' => 'light', 'show_faces' => 'on', 'show_stream' => false, 'show_header' => false);
